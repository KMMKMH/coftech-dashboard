          ...
          >
            <VStack spacing={14}>
              <VStack spacing={6} w="full">
                ...
                >
                  <FormControl id="name">
                    <FormLabel>{t("nps.create.name")}</FormLabel>
                    <Input
                      placeholder={t("nps.create.namePlaceholder")}
                  ...
                  <FormControl id="bot">
                    <FormLabel>{t("nps.create.selectBot")}</FormLabel>
                    <Select
                      isSearchable={false}
                ...
                <HStack spacing={8} w={"full"}>
                  <FormControl id="state">
                    <FormLabel>{t("nps.create.state")}</FormLabel>
                    <Select
                      isSearchable={false}
                ...
                {questions.map((q, index) => (
                  ...
                  >
                    <FormControl id={`question-${index}`}>
                      <FormLabel>{`${t("nps.create.question")} ${index + 1
                        }`}</FormLabel>
                      <Input
                        placeholder={t("nps.create.question")}
                        value={q.question}
                        bg={backgroundColor}
                        onChange={(e) =>
                    ...
                    <FormControl id={`type-${index}`}>
                      <FormLabel w={"full"}>{t("nps.create.type")}</FormLabel>
                      <HStack spacing={6}>
                        <Select
                          isSearchable={false}
                          placeholder={t("nps.create.typePlaceholder")}
                          chakraStyles={{
                            container: (provided) => ({
                              ...provided,
                              borderRadius: "5px",
...
export default withTranslation("common")(NewNps);
